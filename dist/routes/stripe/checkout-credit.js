...
router.post('/checkout-credit', async (req, res) => {
    ...
    try {
        ...
        const result = await db_1.default.query('SELECT email, tenant_id FROM users WHERE uid = $1', [uid]);
        ...
        const productName = canal === "contactos"
        ...
        console.error('❌ Error en checkout-credit:', err.message || err);
