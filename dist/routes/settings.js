...
router.post('/', async (req, res) => {
    ...
    try {
        const decoded = jsonwebtoken_1.default.verify(token, JWT_SECRET);
        const { nombre_negocio, categoria, idioma, direccion, horario_atencion, prompt, bienvenida, twilio_number, twilio_sms_number, twilio_voice_number, informacion_negocio, funciones_asistente, info_clave, limite_uso, } = req.body;
        if (!nombre_negocio) {
...
router.put('/', async (req, res) => {
    ...
    try {
        const decoded = jsonwebtoken_1.default.verify(token, JWT_SECRET);
        const { nombre_negocio, categoria, idioma, direccion, horario_atencion, prompt, bienvenida, informacion_negocio, funciones_asistente, info_clave, limite_uso, } = req.body;
