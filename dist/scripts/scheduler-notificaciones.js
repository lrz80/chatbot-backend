...
exports.verificarNotificaciones = verificarNotificaciones;
const db_1 = __importDefault(require("../lib/db"));
const email_sendgrid_1 = require("../lib/senders/email-sendgrid");
const smsNotificacion_1 = require("../lib/senders/smsNotificacion"); // 🔥 Importa la nueva función
...
async function verificarNotificaciones() {
  ...
  `);
    ...
    for (const canal of canales) {
        const { rows: tenants } = await db_1.default.query(`
    ...
    `, [canal]);
        for (const tenant of tenants) {
            ...
            const usadosQuery = await db_1.default.query(`
      ...
      `, [tenant.tenant_id, canal, fechaInicio.toISOString().substring(0, 10)]);
            ...
            const creditosQuery = await db_1.default.query(`
...
Aamy.ai`;
            ...
            if (typeof correo === 'string') {
                ...
                await (0, email_sendgrid_1.sendEmailSendgrid)(mensajeTexto, contactos, 'Aamy.ai', String(tenant.tenant_id), 0, undefined, undefined, 'https://aamy.ai/avatar-amy.png', asunto, asunto);
            ...
            for (const telefono of telefonos) {
                await (0, smsNotificacion_1.sendSMSNotificacion)(mensajeTexto, [telefono]); // 🔥 Usa la nueva función
