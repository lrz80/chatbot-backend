    ...
    `, [canal, mesActual]);
        ...
        Aamy.ai`;
            ...
            if (correos.length > 0) {
                ...
                await (0, email_sendgrid_1.sendEmailSendgrid)(mensajeTexto, contactos, 'Aamy.ai', // ✅ Nombre remitente
            ...
            for (const telefono of telefonos) {
                await (0, sms_1.sendSMS)(mensajeTexto, [telefono], telefono, String(tenant.tenant_id), // ✅ Convertimos a string
