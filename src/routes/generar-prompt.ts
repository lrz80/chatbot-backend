  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Estoy creando un asistente virtual llamado Amy en ${idioma}. Siempre debe presentarse como "Soy Amy, bienvenido a ${tenant.nombre}". Su función principal es: ${descripcion}.
