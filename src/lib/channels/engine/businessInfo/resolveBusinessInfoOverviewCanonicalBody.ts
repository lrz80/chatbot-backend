...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- If BUSINESS_SOURCE clearly supports main services, prefer a bullet-only list of main services.",
    "- Do not include a business-description sentence before the bullets when the main-services list is already sufficient.",
    "- Use at most 5 bullets for broad discovery turns.",
...
function buildUserPrompt(params: {
  ...
  return [
    ...
    "- For broad discovery turns, return only the main services summary when BUSINESS_SOURCE supports it clearly.",
    "- For broad discovery turns, prefer a short bullet list of main services.",
    "- Do not add a business overview sentence if the bullet list alone is sufficient.",
